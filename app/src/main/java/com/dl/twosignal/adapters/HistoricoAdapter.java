...
public class HistoricoAdapter extends ArrayAdapter<HistoricoModel> implements View.OnClickListener {

    private ArrayList<HistoricoModel> dataSet;
    Context mContext;
    ...
    public HistoricoAdapter(ArrayList<HistoricoModel> data, Context context) {
        super(context, R.layout.row_item_hist, data);
        this.dataSet = data;
    ...
    public void onClick(View v) {
        ...
        HistoricoModel dataModel = (HistoricoModel) object;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        HistoricoModel dataModel = getItem(position);
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.row_item_hist, parent, false);
